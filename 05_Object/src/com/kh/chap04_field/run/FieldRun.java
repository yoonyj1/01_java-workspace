...
public class FieldRun {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// 객체 생성을 안해도 실행 가능 / 클래스명 입력해줘야 함.
		
		// 수정하고 싶다면
		FieldTest3.sta = "zzzzzzzzzzzzzzz";
		System.out.println(FieldTest3.sta);
		
		// 절대 변경 안되게 하고싶다면 -> 상수필드로 선언해야함.
		System.out.println(FieldTest3.STA_FIN);
		// FieldTest3.STA_FIN = "ggggggggggg"; => 변경 불가능
		
		System.out.println(Math.PI);
		// Math.PI = 2.9999;
		
		int random = (int)(Math.random()); // 기울임 : static
	}
